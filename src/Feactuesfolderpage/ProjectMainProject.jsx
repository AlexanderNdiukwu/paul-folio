...
const ProjectMainProject = () => {
  return (
    <div  className='md:mx-8 mx-3  rounded-lg'>
        ...
        <div className='md:grid flex flex-col lg:grid-cols-4 md:grid-cols-2 lg:gap-7 gap-7 py-5 text-white/50 '>

        <div className=' w-full h-fit   shadow-lg shadow-[#00c2ff] rounded-2xl pb-3   '>
            <Projectcard imgstyle='object-cover  relative w-full rounded-t-2xl md:h-49 h-37' img='../../images/HeroSectionImage/logo.webp'  imgdetails='Autonomous Drone System' imgdescription='Advanced drone control system with computer vision and autonomous navigation capabilities.' />

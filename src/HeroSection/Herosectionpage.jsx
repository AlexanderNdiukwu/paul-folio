...
<div className='flex  md:text-xl items-center text-black  text-xs md:gap-4 gap-3 pt-2 '>
   ...
   <div className='flex border border-[#f02e00]/20 md:border-[#f02e00]/20 md:bg-[#f02e00] bg-gradient-to-r from-[#f02e00]/30 via-[#f02e00]  to-[#f02e00]/30 lg:hidden  gap-1 rounded-lg justify-center items-center  md:px-8 px-2'>

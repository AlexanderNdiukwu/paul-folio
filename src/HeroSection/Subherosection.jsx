...
/>}
 btndetailsty='md:text-4xl text-lg ' btndetail2sty=' md:text-xl text-[10px] ' btndetail2='Work Experience' style='whitespace-nowrap  '/>
            </div>
             
            <div className='border-black h-16 w-full lg:h-30 border lg:w-74 md:rounded-3xl rounded-xl text-center px-2 py-3  shadow-md md:shadow-lg shadow-[#00c2ff] flex justify-center items-center '>
...
{/* text-[#787878] */}
            ...
            <div  className='   w-full lg:h-30 h-16 lg:w-74 md:rounded-3xl rounded-xl text-center px-2 py-3 shadow-md md:shadow-lg shadow-[#00c2ff] flex justify-center items-center' >
            <Pagebtn btndetail={<CountUp
  from={0}
  to={6}
  separator=","
...
/>} btndetailsty='md:text-4xl text-xl' btndetail2sty=' md:text-xl text-[10px] ' btndetail2='Robotic & AI' style='whitespace-nowrap '/>
            ...
            <div  className=' lg:h-30  h-16 w-full  lg:w-74 md:rounded-3xl rounded-xl text-center px-30  py-2 my-1 border border-[#00c2ff]/20 md:border-0 md:shadow-lg shadow-md shadow-[#00c2ff] flex justify-center items-center col-span-3 lg:col-span-1'>
            <Pagebtn btndetail=
